...
Резюме:
В данном проекте ты познакомишься с типовым жизненным циклом разработки программного обеспечения, типовым ролевым составом команды и основными функциями каждой роли на этапах жизненного цикла. А еще узнаешь такое понятие, как декомпозиция, и освоишь правила применения.
...
4. Министерство труда и социальной защиты Российской Федерации. Профессиональный стандарт «Системный аналитик» : утв. приказом Минтруда России от 27.04.2023 № 367н [Электронный ресурс]. – Режим доступа: https://profstandart.rosmintrud.ru/obshchiy-informatsionnyy-blok/natsionalnyy-reestr-professionalnykh-standartov/reestr-professionalnykh-standartov/index.php?ELEMENT_ID=121409, свободный
5. Microsoft. Work breakdown structures overview [Электронный ресурс] / Microsoft. – Режим доступа: https://learn.microsoft.com/ru-ru/dynamics365/project-operations/prod-pma/work-breakdown-structures, свободный
...
![img2](./misc/images/Рисунок_1._Декомпозиция_подготовки_завтрака.jpg)

*Рисунок 2. Декомпозиция системы Система1*

![img3](./misc/images/Рисунок_2._Декомпозиция_системы_Система1-2.jpg)
...
![img4](misc/images/School_21_-_Рисунок_3._Декомпозиция_завтрака-2.jpg)
